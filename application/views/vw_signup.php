...
<html lang="en">
    <head>
        ...
        <title>Sign Up | Our Teacher</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form id="form_login" action="TA-20DX-Triangle/login_action" method="POST">
                    ...
                    <p>
                        Sudah Punya Akun?
                        <a href="<?= base_url() ?>index.php/Beranda/signin" style="text-decoration: none;color:black;font-weight: 600">Masuk</a>
                    </p>
                </div>
                </form>
                <div class="text-center mt-5">
                    <p>
                        Dengan Sign Up, kamu telah menyetujui
